...
│   │   ├── LlmsPage.php          # llms.txt Einstellungsseite
...
│   │   ├── RobotsPage.php        # robots.txt Manager Einstellungsseite
...
| `bre_llms_clear_cache` | `LlmsPage::ajax_clear_cache` | llms.txt Cache leeren |
